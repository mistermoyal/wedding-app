...
INSERT INTO "new_Vendor" ("category", "createdAt", "customEvePercentage", "customTomPercentage", "estimatedTotal", "fixedGuestCountEve", "fixedGuestCountTom", "guestCountBasis", "id", "includeChildren", "name", "notes", "paymentResponsibility", "pricePerGuest", "pricingModel", "status", "totalAmount", "updatedAt") SELECT "category", "createdAt", "customEvePercentage", "customTomPercentage", "estimatedTotal", "fixedGuestCountEve", "fixedGuestCountTom", "guestCountBasis", "id", "includeChildren", "name", "notes", "paymentResponsibility", "pricePerGuest", "pricingModel", "status", "totalAmount", "updatedAt" FROM "Vendor";
DROP TABLE "Vendor";
